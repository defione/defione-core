...
import "./interfaces/IDefioneVote.sol";
import "./Ownable.sol";


// Defione Token with bridge token logic and non-transferable non-valuable Vote token

//Bridge
// it can only be closed.
// it can only be set once
// Bridge Setter is set during deployement to add bridge address after deployement, //Bridge needs Defione to be deployed prior
...
//Mints VoteTokens 1:1 Defione Tokens


contract DefioneToken is ERC20("Defione Token", "DONE"), Ownable {
    IDefioneVote public voteToken;
    ...
    constructor(IDefioneVote _voteAddress) public{
        devAddr = msg.sender;
